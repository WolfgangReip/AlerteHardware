...
const ProductCard: FC<ProductCardProps> = ({ product }): ReactElement => {
  return (
    <div className="relative cursor-pointer m-4 shadow-lg transform transition-transform hover:scale-105 bg-card-background-color w-96 rounded-3xl font-tertiary">
